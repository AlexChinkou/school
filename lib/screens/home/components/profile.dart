...
import 'package:flutter_school/models/auth.dart';
import 'package:flutter_school/screens/home/home.dart';
import 'package:line_icons/line_icons.dart';
import 'dart:ui';
import 'package:provider/provider.dart';

const Color gradientStart = Colors.blue;
const Color gradientEnd = Colors.lightBlue;
...
class ProfilePage extends StatelessWidget {
    ...
    final secondCard = Padding(
      ...
      child: Material(
        ...
        child: Container(
          ...
          child: Column(
            children: <Widget>[
              _buildIconTile(Icons.supervised_user_circle, Colors.lightBlue,
                  'Change Details'),
              hr,
              _buildIconTile(
                  LineIcons.lock, Colors.blueGrey, 'Change Password'),
              hr,
              GestureDetector(
                child: _buildIconTile(
                    LineIcons.unlock, Colors.purpleAccent, 'Logout'),
                onTap: () {
  ...
  Widget _buildIconTile(IconData icon, Color color, String title) {
    return ListTile(
      ...
      trailing: Icon(LineIcons.calculator),
    );
  }
}
